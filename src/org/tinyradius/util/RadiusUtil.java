...
public class RadiusUtil {
     ...
     * CHAP 加密
     */
    public static byte[] chapEncryption(String userPassword, int chapId, byte[] challenge) {//Secret chapPassword = MD5（Chap ID + userPassword + challenge）
    ...
    /**
     * Encrypt an MPPE password Adapted from FreeRadius
     * src/lib/radius.x:make_tunnel_password
     *
     * @see ??
