...
public class RadiusClient {
    ...
    public synchronized boolean authenticate(String userName, String password) throws IOException, RadiusException {
        return authenticate(userName, password, getAuthProtocol());
    }
     ...
     * @param userName user name
     * @param password password
     * @param protocol either {@link AccessRequest#AUTH_PAP} or
     * {@link AccessRequest#AUTH_CHAP}
     * @return true if authentication is successful, false otherwise
     * @exception RadiusException malformed packet
     * @exception IOException communication error (after getRetryCount()
     * retries)
     ...
     * @throws IOException
     */
    private DatagramPacket makeDatagramPacket(RadiusPacket packet, int port) throws IOException {
     ...
     */
    private RadiusPacket makeRadiusPacket(DatagramPacket packet, RadiusPacket request) throws IOException, RadiusException {
