...
public final class AttributeType {
     ...
     * @param type RadiusAttribute descendant who handles attributes of this
     * type
     */
    ...
    /**
     * Sets the RadiusAttribute descendant class which represents attributes of
     * this type.
     * @param type
     */
    ...
    /**
     * Returns the name of the given integer value if this attribute is an
     * enumeration, or null if it is not or if the integer value is unknown.
     *
     * @param value
     * @return name
     */
    public String getEnumeration(int value) {
        if (enumeration != null) {
            return (String) enumeration.get(value);
        }
        return null;
    }

    /**
     * Returns the number of the given string value if this attribute is an
     * enumeration, or null if it is not or if the string value is unknown.
     *
