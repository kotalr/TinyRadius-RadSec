...
/**
 * The default dictionary is a singleton object containing a dictionary in the
 * memory that is filled on application startup using the default dictionary
 * file from the classpath resource
...
public class DefaultDictionary
    ...
    /**
     * Make constructor private so that a DefaultDictionary cannot be
     * constructed by other classes.
     */
    private DefaultDictionary() {
    }

    private static final String DICTIONARY_RESOURCE = "radius.dir";
    private static DefaultDictionary instance = null;

    /**
     * Creates the singleton instance of this object and parses the classpath
     * ressource.
     */
    static {
        ...
        try {
            ...
            source = DefaultDictionary.class.getResourceAsStream("/" + DICTIONARY_RESOURCE);
            if (source == null) {
                source = DefaultDictionary.class.getResourceAsStream(DICTIONARY_RESOURCE);
            }
