...
/**
 * This class represents a Radius attribute which only contains a 32 bit
 * integer.
 */
public class IntegerAttribute extends RadiusAttribute {
    ...
    /**
     * Returns the value of this attribute as a string. Tries to resolve
     * enumerations.
     *
     ...
     */
    public final void setAttributeValue(int value) {
     ...
     * Sets the value of this attribute.
     *
     * @exception NumberFormatException if value is not a number and constant
     * cannot be resolved
     * @see
