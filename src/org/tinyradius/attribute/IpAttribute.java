...
public class IpAttribute extends RadiusAttribute {
    ...
    /**
     * Returns the attribute value (IP number) as a string of the format
     * "xx.xx.xx.xx".
     *
     ...
     * @see
     * org.tinyradius.attribute.RadiusAttribute#setAttributeValue(java.lang.String)
     */
    @Override
    ...
    /**
     * Returns the IP number as a 32 bit unsigned number. The number is returned
     * in a long because Java does not support unsigned ints.
     *
     * @return IP number
     */
    ...
    /**
     * Sets the IP number represented by this IpAttribute as a 32 bit unsigned
     * number.
     *
     * @param ip
     */
    public final void setIpAsLong(long ip) {
        byte[] data = new byte[4];
