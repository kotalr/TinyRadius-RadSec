...
public class AccountingRequest extends RadiusPacket {
    ...
    public String getStatusTypeName() throws RadiusException {
        switch (getAcctStatusType()) {
            case ACCT_STATUS_TYPE_START:
                return "Start";
            case ACCT_STATUS_TYPE_INTERIM_UPDATE:
                return "Update";
            case ACCT_STATUS_TYPE_STOP:
                return "Stop";
            case ACCT_STATUS_TYPE_ACCOUNTING_ON:
                return "AcctOn";
            case ACCT_STATUS_TYPE_ACCOUNTING_OFF:
                return "AcctOff";
            default:
                return "Unknow";
        }
