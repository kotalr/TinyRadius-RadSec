...
/**
 * Test proxy server. Listens on localhost:1812 and localhost:1813. Proxies
 * every access request to localhost:10000 and every accounting request to
 * localhost:10001. You can use TestClient to ask this TestProxy and TestServer
 * with the parameters 10000 and 10001 as the target server. Uses "testing123"
 * as the shared secret for the communication with the target server
 * (localhost:10000/localhost:10001) and "proxytest" as the shared secret for
 * the communication with connecting clients.
 */
